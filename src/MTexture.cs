    ...
    public class MTexture
    {
...
#endif
            MonoCelesteClassic.Draw.SpriteBatch.Draw(Texture, position, ClipRect, Color.White, 0, -DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MonoCelesteClassic.Draw.SpriteBatch.Draw(Texture, position, ClipRect, Color.White, 0, origin - DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MonoCelesteClassic.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, origin - DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color, float scale)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MonoCelesteClassic.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, origin - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color, float scale, float rotation)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MonoCelesteClassic.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, origin - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color, float scale, float rotation, SpriteEffects flip)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MonoCelesteClassic.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, origin - DrawOffset, scale, flip, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color, Vector2 scale, float rotation, Rectangle clip)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MonoCelesteClassic.Draw.SpriteBatch.Draw(Texture, position, GetRelativeRect(clip), color, rotation, origin - DrawOffset, scale, SpriteEffects.None, 0);
        }
